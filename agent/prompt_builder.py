...
MEMORY_GUIDANCE = (
    ...
    "the user's explicit preferences, corrections and repeated rejections may enter the user "
    "profile as self-reports that the user can later change; account "
    ...
    "silently rewrite the account model after one sample. Users never accept or reject system "
    "learning candidates; evidence, replay, freshness and conflict gates do that silently. "
