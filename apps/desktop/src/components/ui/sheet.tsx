...
function SheetOverlay({ className, ...props }: React.ComponentProps<typeof SheetPrimitive.Overlay>) {
  return (
    <SheetPrimitive.Overlay
      className={cn(
        'fixed inset-0 z-50 bg-black/18 backdrop-blur-[0.1875rem] duration-[var(--mos-motion-standard)] data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0',
        className
      )}
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        className={cn(
          'fixed z-50 flex flex-col gap-3 border-(--ui-stroke-tertiary) bg-(--ui-sidebar-surface-background) text-[length:var(--conversation-text-font-size)] shadow-nous transition ease-[var(--mos-ease-out)] data-[state=closed]:animate-out data-[state=closed]:duration-[var(--mos-motion-standard)] data-[state=open]:animate-in data-[state=open]:duration-[var(--mos-motion-standard)]',
          side === 'right' &&
