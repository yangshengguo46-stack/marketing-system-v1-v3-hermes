...
const badgeVariants = cva(
  'inline-flex w-fit shrink-0 items-center gap-1 rounded-[5px] px-1.5 py-0.5 text-[0.65rem] font-medium leading-none whitespace-nowrap [&_svg]:size-3 [&_svg]:pointer-events-none',
  {
    variants: {
      variant: {
